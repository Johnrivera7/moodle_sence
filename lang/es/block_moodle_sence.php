...
$string['report_view_participants'] = 'Por participante';
$string['report_view_daily'] = 'Por día';
$string['daily_intro'] = 'Historial de sesiones SENCE agrupado por día: hora de inicio, cierre y si el cierre sigue pendiente. Los cierres anteriores a esta versión pueden aparecer sin hora de cierre.';
$string['daily_filter_all'] = 'Todos los días';
$string['daily_empty'] = 'Aún no hay sesiones SENCE registradas en este curso.';
$string['daily_total_sessions'] = 'Sesiones';
$string['daily_status_open'] = 'Cierre pendiente';
$string['daily_status_closed'] = 'Cerrada';
$string['daily_status_unknown'] = 'Cierre sin hora';
$string['daily_col_start'] = 'Inicio';
$string['daily_col_end'] = 'Cierre';
$string['daily_col_duration'] = 'Duración';
$string['daily_end_pending'] = 'Pendiente de cierre';
$string['daily_end_unknown'] = 'Sin registrar';
$string['daily_pending_count'] = '{$a} con cierre pendiente';
$string['daily_unknown_user'] = 'Usuario no encontrado';
