...
$string['iniciarsesion'] = 'Inicio sesión SENCE';
$string['cerrarsesion'] = 'Cierre sesión SENCE';
...
$string['noidnumber'] = 'Su usuario debe tener RUT en el campo número de ID (idnumber) o en el nombre de usuario.';
$string['invalidrun'] = 'RUT no configurado o incorrecto. Por favor, <a href="{$a}">ingréselo en el campo Número de ID de su perfil</a>.';
...
$string['mustlogin'] = 'Debe iniciar sesión SENCE antes de acceder al curso.';
