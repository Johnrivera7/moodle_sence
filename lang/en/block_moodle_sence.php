...
$string['report_view_participants'] = 'By participant';
$string['report_view_daily'] = 'By day';
$string['daily_intro'] = 'SENCE session history grouped by day: start time, end time, and whether close is still pending. Closures from before this version may appear without an end time.';
$string['daily_filter_all'] = 'All days';
$string['daily_empty'] = 'No SENCE sessions recorded for this course yet.';
$string['daily_total_sessions'] = 'Sessions';
$string['daily_status_open'] = 'Close pending';
$string['daily_status_closed'] = 'Closed';
$string['daily_status_unknown'] = 'End time unknown';
$string['daily_col_start'] = 'Start';
$string['daily_col_end'] = 'End';
$string['daily_col_duration'] = 'Duration';
$string['daily_end_pending'] = 'Pending close';
$string['daily_end_unknown'] = 'Not recorded';
$string['daily_pending_count'] = '{$a} pending close';
$string['daily_unknown_user'] = 'User not found';
