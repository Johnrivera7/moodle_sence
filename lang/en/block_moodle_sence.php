...
$string['reminder_help'] = 'Use <strong>Remind</strong> on each pending row. The email goes to the participant and you receive a <strong>CC copy</strong>. Not used for OK attendance or scholarship users.';
...
$string['reminder_confirm_user'] = 'Send a reminder to <strong>{$a->fullname}</strong> (&lt;{$a->email}&gt;)?<br>Status: {$a->status}<br>Course: {$a->course}<br><br>You (<strong>{$a->sender}</strong> — {$a->senderemail}) will receive a <strong>CC copy</strong> of the same email.';
$string['reminder_user_button'] = 'Remind';
$string['reminder_user_button_help'] = 'Send reminder to this participant (CC to you)';
...
$string['reminder_user_sent'] = 'Reminder sent to {$a->fullname} ({$a->email}). CC sent to {$a->sender}.';
